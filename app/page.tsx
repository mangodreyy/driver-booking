    ...
    return (
      <div className="min-h-screen flex items-center justify-center p-4" style={{ background: "#fff7f0" }}>
        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-md w-full text-center">
          ...
          <p className="text-gray-400 mb-5 text-sm">Slot reserved. Admin has been notified via MiWorkPro.</p>
          ...
          <div className="flex flex-col gap-3 mb-3">
            {/* Feishu / MiWorkPro only */}
            <div
              className="inline-flex items-center gap-3 font-semibold px-5 py-3 rounded-xl w-full justify-center border-2"
